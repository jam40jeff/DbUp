...
namespace DbUp.Helpers
{
    ...
    public class NullJournal : IJournal
    {
        ...
        /// </summary>
        /// <returns></returns>
        public AppliedSqlScript[] GetExecutedScripts() => new AppliedSqlScript[0];
        ...
        public void StoreExecutedScript(PreparedSqlScript script, Func<IDbCommand> dbCommandFactory)
        { }
